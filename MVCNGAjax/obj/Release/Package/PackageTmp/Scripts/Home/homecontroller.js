//homeModule.controller("homeController", function ($scope, homeService) {
//    homeService.getTalks().then(function (talks) { $scope.talks = talks }, function ()
...
/* Controllers */
angular.module('homeController.controllers', [function () {
    ...
    .controller('homeController', ['$scope', '$http', function ($scope, $http) {
        $scope.model = {};
            ...
            $http({
                url: '/home/GetTalkDetails',
                method: "GET"
            }).
                success(function (data, status, headers, config) {
                    $scope.model.talks = data;
                }).
